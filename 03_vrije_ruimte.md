...
### Fase 1 — Oriëntatie en literatuur (6 uur)
Doelen:
...
### Fase 2 — Opzetten van een basis registry (8 uur)
Doelen:
...
### Fase 3 — Integratieconcept met MCP + LangChain (8 uur)
Doelen:
...
### Fase 4 — Workflow‑structuur met LangGraph (6 uur)
Doelen:
...
### Fase 5 — Rapportage en afronding (4 uur)
Doelen:
...
De daadwerkelijke uitwerking volgt in een later stadium, maar zal bestaan uit:
